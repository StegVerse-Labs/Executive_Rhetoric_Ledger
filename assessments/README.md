...
event_packet_status: "7-catalogued-partial"
...
- [DH-FORCE-007 reported arrests](events/DH-FORCE-007-reported-arrests.json)

Five packets derive from direct visual observations in the supplied recording. Two packets preserve materially relevant secondary reports—observer or mediator contact and six reported arrests—while explicitly retaining their lower-confidence and missing-primary-evidence posture.

Validation records:

- Current seven-event repair-inclusive scope: `validation_results/delaney-hall-assessment-b95a6926.pending.json`
